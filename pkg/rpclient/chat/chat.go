...
func (o *ChatClient) SearchUserPublicInfo(ctx context.Context, req *chat.SearchUserPublicInfoReq) (*chat.SearchUserPublicInfoResp, error) {
	return o.client.SearchUserPublicInfo(ctx, req)
}

func (o *ChatClient) SearchUserID(ctx context.Context, req *chat.SearchUserIDReq) (*chat.SearchUserIDResp, error) {
	return o.client.SearchUserID(ctx, req)
}
